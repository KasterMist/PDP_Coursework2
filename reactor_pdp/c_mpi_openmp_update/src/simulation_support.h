...
bool determineAndHandleIfNeutronFuelCollision(double, struct channel_struct*, int, double ****, int, int, int);
int fissionPu240(struct channel_struct*, double ****, int, int, int);
int fissionU236(struct channel_struct *, double ****, int, int, int);
